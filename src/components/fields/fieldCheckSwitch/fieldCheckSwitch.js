    ...
    <>
      {type === 'switch' ? (
        field ? (
          ...
          >
            <View onPress={() => changeValue(!localValue)} style={styles.switchBoxTextInner}>
              <Text style={[theme.FONTS.body_SF_R_14, styles.switchBoxText]}>{field?.name}</Text>
            </View>
            <Switch
              value={localValue}
        ...
        <View style={styles.nonStandartVinWrapper}>
          ...
          <TouchableOpacity onPress={() => changeValue(!localValue)} style={styles.checkBoxLabelInner}>
            <Text style={[theme.FONTS.body_SF_R_14, styles.checkBoxLabel]}>{field?.name}</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <></>
...
export default FieldCheckSwitch;
